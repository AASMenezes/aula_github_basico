...
8. Abrirá um novo terminal integrado do RStudio (`Tools > Terminal > New Terminal`), no qual ficarão visiveis dois elementos visuais: o menu suspenso "Git/Controle" de versão e a guia "Git/Controle de versão".
...
1.  Clone o repositório [aula_github_basico](https://github.com/AASMenezes/aula_github_basico).
